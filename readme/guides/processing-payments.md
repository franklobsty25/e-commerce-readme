...
Payment flows on Integrations use the store’s configured providers (for example Paystack, Hubtel, Stripe). Partners typically create an order, redirect the shopper, then verify payment.
