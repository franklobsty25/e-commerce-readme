...
Use OAuth when you build a **partner app** that merchants install on their stores. After install and authorization, call the same Integrations routes with an access token instead of a store API key.
